...
class ConvBlock(keras.layers.Layer):
    def __init__(self, out_ch=3, dirate=1):
        ...
        self.conv = tf.layers.Conv2D(out_ch, (3, 3), strides=1, padding='same', dilation_rate=dirate)
...
class RSU7(keras.layers.Layer):
    def __init__(self, mid_ch=12, out_ch=3):
        ...
        self.conv_b0 = ConvBlock(out_ch=out_ch, dirate=1)
        self.conv_b1 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.pool1 = MaxPool2D(2, strides=(2, 2))

        self.conv_b2 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.pool2 = MaxPool2D(2, strides=(2, 2))

        self.conv_b3 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.pool3 = MaxPool2D(2, strides=(2, 2))

        self.conv_b4 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.pool4 = MaxPool2D(2, strides=(2, 2))

        self.conv_b5 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.pool5 = MaxPool2D(2, strides=(2, 2))

        self.conv_b6 = ConvBlock(out_ch=mid_ch, dirate=1)
        self.conv_b7 = ConvBlock(out_ch=mid_ch, dirate=2)

        self.conv_b6_d = ConvBlock(out_ch=mid_ch, dirate=1)
        self.upsample_1 = UpSampling2D(size=(2, 2))
        self.conv_b5_d = ConvBlock(out_ch=mid_ch, dirate=1)
        self.upsample_2 = UpSampling2D(size=(2, 2))
        self.conv_b4_d = ConvBlock(out_ch=mid_ch, dirate=1)
        self.upsample_3 = UpSampling2D(size=(2, 2))
        self.conv_b3_d = ConvBlock(out_ch=mid_ch, dirate=1)
        self.upsample_4 = UpSampling2D(size=(2, 2))
        self.conv_b2_d = ConvBlock(out_ch=mid_ch, dirate=1)
        self.upsample_5 = UpSampling2D(size=(2, 2))
        self.conv_b1_d = ConvBlock(out_ch=out_ch, dirate=1)
